...
export class FooterComponent implements OnInit {
  ...
  countdownforOTP() {
    ...
    //   let timer: any = this.resendbuttonText;
    //   timer = timer.split(':');
    //   let minutes = timer[0];
    //   let seconds = timer[1];
    //   seconds -= 1;
  ...
  verifytheOtp() {
    ...
    // let otp = this.footerotp1.toString() + this.footerotp2.toString() + this.footerotp3.toString() + this.footerotp4.toString() + this.footerotp5.toString() + this.footerotp6.toString();
    ...
    //         let encryptedTokenCustomer = { "token": response.data.token.customer };
    ...
    //         let encryptedTokenAgent = { "token": response.data.token.agent };
  ...
  scrollToTerms() {
    window.open('/terms-of-use#terms-section', '_blank');
  }
  knowMore(){
